...
?>
<link rel="stylesheet" href="/resource/pf.css">
<link rel="stylesheet" href="/resource/common.css">

<nav>
    <h1>포트폴리오</h1>
    <ul class="port flex flex-jc-c flex-ai-c">
        <li class="flex gm"><a href="/pf/gm/index.php"><img
                    src="https://yousangyeop.github.io/img1/blog/article/pf/gm.png" alt=""></a></li>
        <li class="flex dv"><a href="/pf/dv/index.php"><img
                    src="https://yousangyeop.github.io/img1/blog/article/pf/dv.png" alt=""></a></li>
    ...
    <ul class="port-1 flex flex-jc-c flex-ai-c">
        <li class="flex yp"><a href="/pf/yp/index.php"><img
                    src="https://yousangyeop.github.io/img1/blog/article/pf/yp.png" alt=""></a></li>
    ...
    <ul class="port-2 flex flex-jc-c flex-ai-c">
        <li class="pp"><a href="/pf/page/pp.php"><img src="https://yousangyeop.github.io/img1/pf/page/port-page.png" alt=""></a></li>
        <li class="dp"><a href="/pf/page/dp.php"><img src="https://yousangyeop.github.io/img1/pf/page/port-page.png" alt=""></a></li>
    </ul>
    <h1>디자인</h1>
    <ul class="design">
        <li class="cup"><a href="https://yousangyeop.github.io/img1/blog/article/pf/cup.png">잔받침</a>
        </li>
        <li class="logo"><a href="https://yousangyeop.github.io/img1/blog/article/pf/logo.png">로고 ver1</a>
        </li>
