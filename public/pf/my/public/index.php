...
<div id="fullpage">
    ...
    <div class="section page1">
        <div class="meteor-field" style="background-image:url('https://yousangyeop.github.io/img1/pf/my/back.png')">
            ...
            <div class="meteor meteor-2" data-meteor-delay="1000" data-meteor-duration="6000" data-meteor-x="-3000">
                <div>
                    <div></div>
                    <div></div>
                    <div></div>
        ...
        <ul class="top-text">
            <li class="text-1">In The Interest Of</li>
            <li class="text-2">web designer <br> art director <br> branding </li>
            ...
            <div class="item-select cell relative">
                <div class="item-1-sel absolute active">
                    ...
                    <ul class="link-box flex">
                        <li class="flex"><img src="https://yousangyeop.github.io/img1/pf/my/ps.png" alt=""></li>
                        <li class="flex"><img src="https://yousangyeop.github.io/img1/pf/my/ai.png" alt=""></li>
                    </ul>
                </div>
