...
<body>
    <div class="con flex-ai-c">
        ...
        <div class="main flex flex-jc-c flex-1-0-0">
            <h1 class="flex">STCO</h1>
            <h4 class="flex">ONLINE MALL</h4>
        </div>
        <ul class="right-menu flex flex-1-0-0 flex-jc-end">
            <li class="flex"><a href="#">로그인</a></li>
            <li class="flex"><a href="#">회원가입</a></li>
            <li class="flex"><a href="#">장바구니</a></li>
            <li class="flex"><a href="#">고객센터</a></li>
        </ul>
    </div>
